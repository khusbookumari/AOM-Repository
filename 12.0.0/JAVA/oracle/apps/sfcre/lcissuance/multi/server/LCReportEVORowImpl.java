...
import oracle.apps.sfc.lcissuance.multi.schema.server.LCReportEOImpl;
...
// ---------------------------------------------------------------------
public class LCReportEVORowImpl extends OAViewRowImpl {
    ...
    public static final int SNO = 49;

    /**This is the default constructor (do not remove)
     */
    public LCReportEVORowImpl() {
    }
    ...
    /**Gets LCReportEO entity object.
     */
    public LCReportEOImpl getLCReportEO() {
        return (LCReportEOImpl)getEntity(0);
    }


    /**Gets the attribute value for LC_REP_ID using the alias name LcRepId
     */
    public Number getLcRepId() {
        return (Number) getAttributeInternal(LCREPID);
    }

    /**Sets <code>value</code> as attribute value for LC_REP_ID using the alias name LcRepId
     */
    public void setLcRepId(Number value) {
        setAttributeInternal(LCREPID, value);
    }

    /**Gets the attribute value for BANK_REF_NUMBER using the alias name BankRefNumber
     */
    public String getBankRefNumber() {
        return (String) getAttributeInternal(BANKREFNUMBER);
    }

    /**Sets <code>value</code> as attribute value for BANK_REF_NUMBER using the alias name BankRefNumber
     */
    public void setBankRefNumber(String value) {
        setAttributeInternal(BANKREFNUMBER, value);
    }

    /**Gets the attribute value for ACCEPTANCE_VALUE using the alias name AcceptanceValue
     */
    public Number getAcceptanceValue() {
        return (Number) getAttributeInternal(ACCEPTANCEVALUE);
    }

    /**Sets <code>value</code> as attribute value for ACCEPTANCE_VALUE using the alias name AcceptanceValue
     */
    public void setAcceptanceValue(Number value) {
        setAttributeInternal(ACCEPTANCEVALUE, value);
    }

    /**Gets the attribute value for AMOUNT_IN_INR using the alias name AmountInInr
     */
    public Number getAmountInInr() {
        return (Number) getAttributeInternal(AMOUNTININR);
    }

    /**Sets <code>value</code> as attribute value for AMOUNT_IN_INR using the alias name AmountInInr
     */
    ...
    /**Gets the attribute value for SOURCE_OF_FUNDS using the alias name SourceOfFunds
     */
    public String getSourceOfFunds() {
        return (String) getAttributeInternal(SOURCEOFFUNDS);
    }

    /**Sets <code>value</code> as attribute value for SOURCE_OF_FUNDS using the alias name SourceOfFunds
     */
    ...
    /**Gets the attribute value for MARGIN_VALUE using the alias name MarginValue
     */
    public Number getMarginValue() {
        return (Number) getAttributeInternal(MARGINVALUE);
    }

    /**Sets <code>value</code> as attribute value for MARGIN_VALUE using the alias name MarginValue
     */
    public void setMarginValue(Number value) {
        setAttributeInternal(MARGINVALUE, value);
    }

    /**Gets the attribute value for LC_COMMISSION using the alias name LcCommission
     */
    public Number getLcCommission() {
        return (Number) getAttributeInternal(LCCOMMISSION);
    }

    /**Sets <code>value</code> as attribute value for LC_COMMISSION using the alias name LcCommission
     */
    ...
    /**Gets the attribute value for ESTIMATED_PAYMENT_DATE using the alias name EstimatedPaymentDate
     */
    public Date getEstimatedPaymentDate() {
        return (Date) getAttributeInternal(ESTIMATEDPAYMENTDATE);
    }

    /**Sets <code>value</code> as attribute value for ESTIMATED_PAYMENT_DATE using the alias name EstimatedPaymentDate
     */
    public void setEstimatedPaymentDate(Date value) {
        setAttributeInternal(ESTIMATEDPAYMENTDATE, value);
    }

    /**Gets the attribute value for TL_PROJECT_NAME using the alias name TlProjectName
     */
    public String getTlProjectName() {
        return (String) getAttributeInternal(TLPROJECTNAME);
    }

    /**Sets <code>value</code> as attribute value for TL_PROJECT_NAME using the alias name TlProjectName
     */
