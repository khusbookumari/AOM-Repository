...
// ---------------------------------------------------------------------
public class LCDocDetailsRevVORowImpl extends OAViewRowImpl {
     ...
     */
    public LCDocDetailsRevVORowImpl() {
    }


    /**Gets the attribute value for the calculated attribute LcDocId
     */
    public Number getLcDocId() {
        return (Number) getAttributeInternal(LCDOCID);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute LcDocId
     */
    ...
    /**Gets the attribute value for the calculated attribute DocumentsRequired
     */
    public String getDocumentsRequired() {
        return (String) getAttributeInternal(DOCUMENTSREQUIRED);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute DocumentsRequired
     */
    public void setDocumentsRequired(String value) {
        setAttributeInternal(DOCUMENTSREQUIRED, value);
    }

    /**Gets the attribute value for the calculated attribute AdditionalConditions
     */
    public String getAdditionalConditions() {
        return (String) getAttributeInternal(ADDITIONALCONDITIONS);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute AdditionalConditions
     */
