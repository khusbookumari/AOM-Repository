...
import oracle.apps.sfc.lcissuance.multi.schema.server.LCInlandReqEOImpl;
...
// ---------------------------------------------------------------------
public class LCInlandReqEVORowImpl extends OAViewRowImpl {
    public static final int ROWID = 0;
    public static final int LCREQUESTID = 1;
    public static final int LCINLANDID = 2;
    public static final int TYPEOFLC = 3;
    public static final int APPLICANTBANKNAME = 4;
    public static final int PERIODOFPRESENTATION = 5;
    public static final int BANKCHARGES = 6;
    public static final int CONFIRMATIONINSTR = 7;
     ...
     */
    public LCInlandReqEVORowImpl() {
    }

    /**Gets LCInlandReqEO entity object.
     */
    public LCInlandReqEOImpl getLCInlandReqEO() {
        return (LCInlandReqEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for LC_INLAND_ID using the alias name LcInlandId
     */
    public Number getLcInlandId() {
        return (Number) getAttributeInternal(LCINLANDID);
    }

    /**Sets <code>value</code> as attribute value for LC_INLAND_ID using the alias name LcInlandId
     */
    ...
    /**Gets the attribute value for APPLICANT_BANK_NAME using the alias name ApplicantBankName
     */
    public String getApplicantBankName() {
        return (String) getAttributeInternal(APPLICANTBANKNAME);
    }

    /**Sets <code>value</code> as attribute value for APPLICANT_BANK_NAME using the alias name ApplicantBankName
     */
    public void setApplicantBankName(String value) {
        setAttributeInternal(APPLICANTBANKNAME, value);
    }

    /**Gets the attribute value for PERIOD_OF_PRESENTATION using the alias name PeriodOfPresentation
     */
    public String getPeriodOfPresentation() {
        return (String) getAttributeInternal(PERIODOFPRESENTATION);
    }

    /**Sets <code>value</code> as attribute value for PERIOD_OF_PRESENTATION using the alias name PeriodOfPresentation
     */
    public void setPeriodOfPresentation(String value) {
        setAttributeInternal(PERIODOFPRESENTATION, value);
    }

    /**Gets the attribute value for BANK_CHARGES using the alias name BankCharges
     */
    public String getBankCharges() {
        return (String) getAttributeInternal(BANKCHARGES);
    }

    /**Sets <code>value</code> as attribute value for BANK_CHARGES using the alias name BankCharges
     */
    public void setBankCharges(String value) {
        setAttributeInternal(BANKCHARGES, value);
    }

    /**Gets the attribute value for CONFIRMATION_INSTR using the alias name ConfirmationInstr
     */
    public String getConfirmationInstr() {
        return (String) getAttributeInternal(CONFIRMATIONINSTR);
    }

    /**Sets <code>value</code> as attribute value for CONFIRMATION_INSTR using the alias name ConfirmationInstr
     */
